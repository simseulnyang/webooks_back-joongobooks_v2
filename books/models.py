...
class Book(models.Model):
    ...
    category = models.CharField(max_length=50, choices=Category.choices, default=Category.NOVEL, verbose_name='카테고리')
    sale_condition = models.CharField(max_length=20, choices=SALE_CONDITION_CHOICES.choices, default=SALE_CONDITION_CHOICES.FOR_SALE, verbose_name='판매 상태')
